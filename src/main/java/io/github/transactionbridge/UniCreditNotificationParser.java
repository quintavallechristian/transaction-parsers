...
public final class UniCreditNotificationParser implements NotificationParser {
    ...
    @Override public Transaction parse(long occurredAt, String rawText) {
        ...
        try {
            ...
            return amount.signum() > 0 && !merchant.isEmpty()
                    ? new Transaction(occurredAt, amount, "EUR", merchant, text, "unicredit-notification")
                    : null;
